        ...
        <div class="invoice-hero no-print">
            <div class="hero-content">
                <div>
                    ...
                    <h1 class="hero-title">Vehicle Rental Invoice</h1>
                    <p class="hero-subtitle">
                        View complete billing details including rent amount, cancellation penalty,
                ...
                <div class="invoice-card">
                    ...
                    <div class="invoice-top">
                        <div class="invoice-brand">
                            ...
                            <p>
                                Professional vehicle rental service<br>
                                Cars • Bikes • Scooters
                            </p>
                        </div>
                    ...
                    <div class="invoice-body">
                        ...
                        <div class="details-grid">
                            ...
                            <div class="detail-box">
                                ...
                                <div class="detail-line">
                                    ...
                                    <span class="detail-value"><%= safe(b.getStatus()) %></span>
                                </div>

                                <div class="detail-line">
                                    <span class="detail-label">Payment</span>
                                    <span class="detail-value"><%= safe(b.getPaymentStatus()) %></span>
                                </div>
                            </div>
                        ...
                        <div class="invoice-note">
                            ...
                            Final amount may include rent, late fine, damage charges or cancellation penalty based on booking status.
                        </div>
